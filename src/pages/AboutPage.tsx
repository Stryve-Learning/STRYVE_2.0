...
import { BookOpen, Code, Mic, Calculator, Users, Target, Heart } from 'lucide-react';

const AboutPage = () => {
  const tutors = [
    {
      name: 'Saisatvik Koppu',
      subjects: ['Competition Math 2', 'Python Fundamentals', 'Public Speaking'],
    ...
    },
    {
      ...
      subjects: ['Stocks / Financial Literacy', 'Public Speaking', 'Cybersecurity'],
      ...
      color: 'bg-purple-500',
      icon: Calculator,
      tags: ['💼 Stocks / Financial Literacy', '🎤 Public Speaking', '🔐 Cybersecurity'],
    ...
    },
    {
      ...
      color: 'bg-teal-500',
      icon: Calculator,
      tags: ['🧮 Competition Math 1', '🌌 Astronomy', '🧠 AI & Machine Learning']
    },
    {
      name: 'Maanit Pande',
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <section className="bg-gradient-to-br from-purple-600 via-blue-600 to-purple-700 text-white py-16 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">About Stryve Learning</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Stryve Learning was founded by a group of high-achieving students who noticed a significant trend in the vagueness of other tutoring services and wanted to bridge the gap and create FREE online tutoring, for more niche subjects. We believe that peer-to-peer learning creates a unique environment 
                where students feel more comfortable asking questions and taking risks.
              </p>
              <p className="text-gray-600 mb-6">
                What started as a small idea turned into a national success, amassing 4000 enrollments in our most recent year. We're not just 
                tutors, we are students ourselves and know how to teach as we've overcame that sturggle before.
              </p>
              <div className="grid grid-cols-3 gap-4 mt-8">
                ...
                <div className="text-center">
                  <div className="bg-blue-100 rounded-full p-4 mb-2 w-16 h-16 flex items-center justify-center mx-auto">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-8">
              ...
              <p className="text-gray-700 mb-6">
                At Stryve Learning, we are a youth-led tutoring and enrichment non-profit organization committed to making education accessible, engaging, and empowering for young children. Our mission is to create a supportive environment where students feel confident, curious, and motivated to grow, both academically and personally. By connecting passionate teen mentors with eager young learners, we aim to build strong foundations, inspire lifelong learning, and foster meaningful community impact.
              </p>
              <div className="space-y-3">
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                  <span className="text-gray-700">Personalized learning approaches</span>
                </div>
                <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                  <span className="text-gray-700">Building confidence and academic skills</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {tutors.map((tutor, index) => (
              <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div className={`${tutor.color} h-32 flex items-center justify-center`}>
                  <tutor.icon className="h-10 w-10 text-white" />
                </div>
                {tutor.photo && (
                  <img src={tutor.photo} alt={tutor.name} className="w-24 h-24 object-cover rounded-full mx-auto mb-4 border-4 border-white shadow" />
                )}
                <div className="p-6">
      ...
      <section className="py-16 bg-gradient-to-r from-blue-100 via-white to-purple-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12">Why Choose Stryve Learning?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our tutors are students themselves, creating a relatable and comfortable learning environment with modern teaching methods and more simplistic ways.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                95% of our students see grade improvements within the first month, with lots of them achieving 
                their target scores and academic goals.
              </p>
            </div>
            <div className="text-center">
              <div className="bg-purple-100 rounded-full p-6 mb-4 w-20 h-20 flex items-center justify-center mx-auto">
              ...
              <p className="text-gray-600">
                Every class is FREE, and a person can join any number of classes to their liking.
              </p>
            </div>
          </div>
        </div>
