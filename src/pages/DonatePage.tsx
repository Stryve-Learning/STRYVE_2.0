...
import { Heart, BookOpen, Users, Target, Gift, DollarSign, QrCode } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Every dollar you donate directly impacts a student's educational journey. Your support helps us:
              </p>
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Provide Free Tutoring</h3>
                    <p className="text-gray-600">Give students access to high-quality tutoring regardless of their financial situation</p>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Expand Our Reach</h3>
                    <p className="text-gray-600">Serve more students in underserved communities and rural areas</p>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Improve Technology</h3>
                    <p className="text-gray-600">Upgrade our online learning platform and provide better resources</p>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Support Student Tutors</h3>
                    <p className="text-gray-600">Provide materials and training for our volunteer student tutors</p>
                  </div>
                </li>
              </ul>
            </div>
            <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-8">
              <h3 className="text-2xl font-bold mb-6 text-gray-900">Our Impact So Far</h3>
      ...
      <section className="py-16 bg-gradient-to-r from-purple-100 via-blue-50 to-purple-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h3 className="text-xl font-bold text-center mb-8">Donation Methods</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">Quick and secure online donations</p>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">Bank transfer, check, or crypto</p>
      ...
      <section className="py-16 bg-gradient-to-br from-blue-600 via-purple-600 to-blue-700 text-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto text-blue-100">
            Your donation, no matter the size, helps a student achieve their academic dreams. Join us in building a brighter future through education.
          </p>
